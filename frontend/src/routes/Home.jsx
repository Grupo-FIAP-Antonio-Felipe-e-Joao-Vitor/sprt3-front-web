    ...
    <main>
      <div className="md:relative object-center bg-cover bg-center bg-no-repeat bg-none md:bg-[url('/imagemhome.jpg')]">
        ...
        <div className='p-3 md:relative flex flex-col w-full justify-center items-center z-10'>
          ...
          <div className='md:bg-white/80 max-w-4xl md:mt-60 flex flex-col justify-center text-center items-center p-4 gap-5 rounded-2xl'>
        ...
        <div className='flex flex-col w-full justify-center items-center'>
          ...
          <div className='ml-5 md:mb-10 relative flex mt-17 group justify-center mr-5'> 
            {/* Card principal */}
